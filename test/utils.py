...
def torch2keras(model: torch.nn.Module, input_variable, verbose=True, change_ordering=False, opset=None):
...
def convert_and_test(model: torch.nn.Module,
                     ...
                     epsilon=1e-5,
                     opset=None):
    k_model = torch2keras(model, input_variable, verbose=verbose, change_ordering=change_ordering, opset=opset)
